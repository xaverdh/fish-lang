...
deriving instance (Show s,ForallX Show t) => Show (Redirect s t)
...
deriving instance (Eq s,ForallX Eq t) => Eq (Redirect s t)
...
deriving instance (Ord s,ForallX Ord t) => Ord (Redirect s t)
